...
padre genera un numero aleatorio se lo pasa al hijo 1 y lo multiplica por 3 y se lo devuelve al padre
el hijo 2 lo multiplica por 2 y se lo devuelve
esto se repite 10 veces (el padre muestra 20 numeros)
'''
